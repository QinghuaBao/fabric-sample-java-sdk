...
public class Config {
    ...
    private static final String DEFAULT_CONFIG = "userStore.properties";
    ...
    private Config() {
        ...
        try {
            ...
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.peer_locations", "peer0.org1.example.com@grpc://211.69.198.56:7051, peer1.org1.example.com@grpc://211.69.198.56:7056");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.orderer_locations", "orderer.example.com@grpc://211.69.198.56:7050");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.eventhub_locations", "peer0.org1.example.com@grpc://211.69.198.56:7053,peer1.org1.example.com@grpc://211.69.198.56:7058");
            ...
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.peer_locations", "peer0.org2.example.com@grpc://211.69.198.56:8051,peer1.org2.example.com@grpc://211.69.198.56:8056");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.orderer_locations", "orderer.example.com@grpc://211.69.198.56:7050");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.eventhub_locations", "peer0.org2.example.com@grpc://211.69.198.56:8053, peer1.org2.example.com@grpc://211.69.198.56:8058");
            ...
            for (Map.Entry<String, SampleOrg> org : sampleOrgs.entrySet()) {
                ...
                if (runningFabricCATLS) {
                    String cert = "channel/crypto-config/peerOrganizations/DNAME/ca/ca.DNAME-cert.pem".replaceAll("DNAME", domainName);
